...
def ProductId(request):
    ...
    return render(request,'PRODUCT.html',{'result':val1,'userId1':val2,'username':val3,'userMobile':val4,'UserId':val5,'products':productsID})
def add(request):
    ...
    val4 = int(request.POST["UserMobile"])
    val5 = int(request.POST["UserId"])
    return render(request,'prdata.html',{'result':val1,'userId1':val2,'username':val3,'userMobile':val4,'UserId':val5,'products':products})
...
def Buy(request):
    ...
    a.stock = val9 - val2
    a.save()
    return render(request,'Quntity.html',{'result':val1,'result1':val2,'result2':res,'userId1':val4,'username':val5,'userMobile':val6,'UserId':val7,'products':products})
def Confirm(request):
    if request.method == 'POST':
        products = Product.objects.all()
        ...
        return render(request, 'Confirm.html',
                      {'username': val2, 'userMobile': val3,'UserId': val4,'userId1': val5, 'Buyproducts': BuyProducts1})
...
def NewPro(request):
    ...
    if request.method == 'POST':
        ...
        BuyProducts1 = BuyProducts.objects.filter(Client_name=val2, client_mobile=val3, Userdid=val4, randid=val5)
        return render(request, 'NewPro.html',
                      {'username': val2, 'userMobile': val3, 'UserId': val4, 'userId1': val5,'products': ShopProduct,
